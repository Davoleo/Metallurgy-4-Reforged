...
public class ModTools {
    ...
    public static ItemAxeBase amordrine_axe = new ItemAxeBase(Metallurgy_5.amordrineToolMaterial, "amordrine_axe");
    public static ItemHoeBase amordrine_hoe = new ItemHoeBase(Metallurgy_5.amordrineToolMaterial, "amordrine_hoe");
    public static ItemPickaxeBase amordrine_pickaxe = new ItemPickaxeBase(Metallurgy_5.amordrineToolMaterial, "amordrine_pickaxe");
    public static ItemShovelBase amordrine_shovel = new ItemShovelBase(Metallurgy_5.amordrineToolMaterial, "amordrine_shovel");
    public static ItemSwordBase amordrine_sword = new ItemSwordBase(Metallurgy_5.amordrineToolMaterial, "amordrine_sword");

    public static ItemAxeBase angmallen_axe = new ItemAxeBase(Metallurgy_5.angmallenToolMaterial, "angmallen_axe");
    public static ItemHoeBase angmallen_hoe = new ItemHoeBase(Metallurgy_5.angmallenToolMaterial, "angmallen_hoe");
    public static ItemPickaxeBase angmallen_pickaxe = new ItemPickaxeBase(Metallurgy_5.angmallenToolMaterial, "angmallen_pickaxe");
    public static ItemShovelBase angmallen_shovel = new ItemShovelBase(Metallurgy_5.angmallenToolMaterial, "angmallen_shovel");
    public static ItemSwordBase angmallen_sword = new ItemSwordBase(Metallurgy_5.angmallenToolMaterial, "angmallen_sword");
    ...
    public static ItemAxeBase atlarus_axe = new ItemAxeBase(Metallurgy_5.atlarusToolMaterial, "atlarus_axe");
    public static ItemHoeBase atlarus_hoe = new ItemHoeBase(Metallurgy_5.atlarusToolMaterial, "atlarus_hoe");
    public static ItemPickaxeBase atlarus_pickaxe = new ItemPickaxeBase(Metallurgy_5.atlarusToolMaterial, "atlarus_pickaxe");
    public static ItemShovelBase atlarus_shovel = new ItemShovelBase(Metallurgy_5.atlarusToolMaterial, "atlarus_shovel");
    public static ItemSwordBase atlarus_sword = new ItemSwordBase(Metallurgy_5.atlarusToolMaterial, "atlarus_sword");

    public static ItemAxeBase black_steel_axe = new ItemAxeBase(Metallurgy_5.blackSteelToolMaterial, "black_steel_axe");
    public static ItemHoeBase black_steel_hoe = new ItemHoeBase(Metallurgy_5.blackSteelToolMaterial, "black_steel_hoe");
    public static ItemPickaxeBase black_steel_pickaxe = new ItemPickaxeBase(Metallurgy_5.blackSteelToolMaterial, "black_steel_pickaxe");
    public static ItemShovelBase black_steel_shovel = new ItemShovelBase(Metallurgy_5.blackSteelToolMaterial, "black_steel_shovel");
    public static ItemSwordBase black_steel_sword = new ItemSwordBase(Metallurgy_5.blackSteelToolMaterial, "black_steel_sword");

    public static ItemAxeBase brass_axe = new ItemAxeBase(Metallurgy_5.brassToolMaterial, "brass_axe");
    public static ItemHoeBase brass_hoe = new ItemHoeBase(Metallurgy_5.brassToolMaterial, "brass_hoe");
    public static ItemPickaxeBase brass_pickaxe = new ItemPickaxeBase(Metallurgy_5.brassToolMaterial, "brass_pickaxe");
    public static ItemShovelBase brass_shovel = new ItemShovelBase(Metallurgy_5.brassToolMaterial, "brass_shovel");
    public static ItemSwordBase brass_sword = new ItemSwordBase(Metallurgy_5.brassToolMaterial, "brass_sword");

    public static ItemAxeBase bronze_axe = new ItemAxeBase(Metallurgy_5.bronzeToolMaterial, "bronze_axe");
    public static ItemHoeBase bronze_hoe = new ItemHoeBase(Metallurgy_5.bronzeToolMaterial, "bronze_hoe");
    public static ItemPickaxeBase bronze_pickaxe = new ItemPickaxeBase(Metallurgy_5.bronzeToolMaterial, "bronze_pickaxe");
    public static ItemShovelBase bronze_shovel = new ItemShovelBase(Metallurgy_5.bronzeToolMaterial, "bronze_shovel");
    public static ItemSwordBase bronze_sword = new ItemSwordBase(Metallurgy_5.bronzeToolMaterial, "bronze_sword");
    ...
    public static ItemAxeBase celenegil_axe = new ItemAxeBase(Metallurgy_5.celenegilToolMaterial, "celenegil_axe");
    public static ItemHoeBase celenegil_hoe = new ItemHoeBase(Metallurgy_5.celenegilToolMaterial, "celenegil_hoe");
    public static ItemPickaxeBase celenegil_pickaxe = new ItemPickaxeBase(Metallurgy_5.celenegilToolMaterial, "celenegil_pickaxe");
    ...
    public static ItemShovelBase damascus_steel_shovel = new ItemShovelBase(Metallurgy_5.damascusSteelToolMaterial, "damascus_steel_shovel");
    public static ItemSwordBase damascus_steel_sword = new ItemSwordBase(Metallurgy_5.damascusSteelToolMaterial, "damascus_steel_sword");

    public static ItemAxeBase deep_iron_axe = new ItemAxeBase(Metallurgy_5.deepIronToolMaterial, "deep_iron_axe");
    public static ItemHoeBase deep_iron_hoe = new ItemHoeBase(Metallurgy_5.deepIronToolMaterial, "deep_iron_hoe");
    public static ItemPickaxeBase deep_iron_pickaxe = new ItemPickaxeBase(Metallurgy_5.deepIronToolMaterial, "deep_iron_pickaxe");
    ...
    public static ItemAxeBase desichalkos_axe = new ItemAxeBase(Metallurgy_5.desichalkosToolMaterial, "desichalkos_axe");
    public static ItemHoeBase desichalkos_hoe = new ItemHoeBase(Metallurgy_5.desichalkosToolMaterial, "desichalkos_hoe");
    public static ItemPickaxeBase desichalkos_pickaxe = new ItemPickaxeBase(Metallurgy_5.desichalkosToolMaterial, "desichalkos_pickaxe");
    public static ItemShovelBase desichalkos_shovel = new ItemShovelBase(Metallurgy_5.desichalkosToolMaterial, "desichalkos_shovel");
    public static ItemSwordBase desichalkos_sword = new ItemSwordBase(Metallurgy_5.desichalkosToolMaterial, "desichalkos_sword");

    public static ItemAxeBase electrum_axe = new ItemAxeBase(Metallurgy_5.electrumToolMaterial, "electrum_axe");
    public static ItemHoeBase electrum_hoe = new ItemHoeBase(Metallurgy_5.electrumToolMaterial, "electrum_hoe");
    public static ItemPickaxeBase electrum_pickaxe = new ItemPickaxeBase(Metallurgy_5.electrumToolMaterial, "electrum_pickaxe");
    public static ItemShovelBase electrum_shovel = new ItemShovelBase(Metallurgy_5.electrumToolMaterial, "electrum_shovel");
    public static ItemSwordBase electrum_sword = new ItemSwordBase(Metallurgy_5.electrumToolMaterial, "electrum_sword");
    ...
    public static ItemAxeBase haderoth_axe = new ItemAxeBase(Metallurgy_5.haderothToolMaterial, "haderoth_axe");
    public static ItemHoeBase haderoth_hoe = new ItemHoeBase(Metallurgy_5.haderothToolMaterial, "haderoth_hoe");
    public static ItemPickaxeBase haderoth_pickaxe = new ItemPickaxeBase(Metallurgy_5.haderothToolMaterial, "haderoth_pickaxe");
    public static ItemShovelBase haderoth_shovel = new ItemShovelBase(Metallurgy_5.haderothToolMaterial, "haderoth_shovel");
    public static ItemSwordBase haderoth_sword = new ItemSwordBase(Metallurgy_5.haderothToolMaterial, "haderoth_sword");

    public static ItemAxeBase hepatizon_axe = new ItemAxeBase(Metallurgy_5.hepatizonToolMaterial, "hepatizon_axe");
    public static ItemHoeBase hepatizon_hoe = new ItemHoeBase(Metallurgy_5.hepatizonToolMaterial, "hepatizon_hoe");
    public static ItemPickaxeBase hepatizon_pickaxe = new ItemPickaxeBase(Metallurgy_5.hepatizonToolMaterial, "hepatizon_pickaxe");
    public static ItemShovelBase hepatizon_shovel = new ItemShovelBase(Metallurgy_5.hepatizonToolMaterial, "hepatizon_shovel");
    public static ItemSwordBase hepatizon_sword = new ItemSwordBase(Metallurgy_5.hepatizonToolMaterial, "hepatizon_sword");
    ...
    public static ItemShovelBase inolashite_shovel = new ItemShovelBase(Metallurgy_5.inolashiteToolMaterial, "inolashite_shovel");
    public static ItemSwordBase inolashite_sword = new ItemSwordBase(Metallurgy_5.inolashiteToolMaterial, "inolashite_sword");
    ...
    public static ItemAxeBase orichalcum_axe = new ItemAxeBase(Metallurgy_5.oureclaseToolMaterial, "orichalcum_axe");
    public static ItemHoeBase orichalcum_hoe = new ItemHoeBase(Metallurgy_5.oureclaseToolMaterial, "orichalcum_hoe");
    public static ItemPickaxeBase orichalcum_pickaxe = new ItemPickaxeBase(Metallurgy_5.oureclaseToolMaterial, "orichalcum_pickaxe");
    public static ItemShovelBase orichalcum_shovel = new ItemShovelBase(Metallurgy_5.oureclaseToolMaterial, "orichalcum_shovel");
    public static ItemSwordBase orichalcum_sword = new ItemSwordBase(Metallurgy_5.oureclaseToolMaterial, "orichalcum_sword");

    public static ItemAxeBase oureclase_axe = new ItemAxeBase(Metallurgy_5.orichalcumToolMaterial, "oureclase_axe");
    public static ItemHoeBase oureclase_hoe = new ItemHoeBase(Metallurgy_5.orichalcumToolMaterial, "oureclase_hoe");
    public static ItemPickaxeBase oureclase_pickaxe = new ItemPickaxeBase(Metallurgy_5.orichalcumToolMaterial, "oureclase_pickaxe");
    public static ItemShovelBase oureclase_shovel = new ItemShovelBase(Metallurgy_5.orichalcumToolMaterial, "oureclase_shovel");
    public static ItemSwordBase oureclase_sword = new ItemSwordBase(Metallurgy_5.orichalcumToolMaterial, "oureclase_sword");

    public static ItemAxeBase platinum_axe = new ItemAxeBase(Metallurgy_5.platinumToolMaterial, "platinum_axe");
    public static ItemHoeBase platinum_hoe = new ItemHoeBase(Metallurgy_5.platinumToolMaterial, "platinum_hoe");
    public static ItemPickaxeBase platinum_pickaxe = new ItemPickaxeBase(Metallurgy_5.platinumToolMaterial, "platinum_pickaxe");
    public static ItemShovelBase platinum_shovel = new ItemShovelBase(Metallurgy_5.platinumToolMaterial, "platinum_shovel");
    public static ItemSwordBase platinum_sword = new ItemSwordBase(Metallurgy_5.platinumToolMaterial, "platinum_sword");
    ...
    public static ItemAxeBase shadow_steel_axe = new ItemAxeBase(Metallurgy_5.shadowSteelToolMaterial, "shadow_steel_axe");
    public static ItemHoeBase shadow_steel_hoe = new ItemHoeBase(Metallurgy_5.shadowSteelToolMaterial, "shadow_steel_hoe");
    public static ItemPickaxeBase shadow_steel_pickaxe = new ItemPickaxeBase(Metallurgy_5.shadowSteelToolMaterial, "shadow_steel_pickaxe");
    public static ItemShovelBase shadow_steel_shovel = new ItemShovelBase(Metallurgy_5.shadowSteelToolMaterial, "shadow_steel_shovel");
    public static ItemSwordBase shadow_steel_sword = new ItemSwordBase(Metallurgy_5.shadowSteelToolMaterial, "shadow_steel_sword");
    ...
    public static ItemAxeBase steel_axe = new ItemAxeBase(Metallurgy_5.steelToolMaterial, "steel_axe");
    public static ItemHoeBase steel_hoe = new ItemHoeBase(Metallurgy_5.steelToolMaterial, "steel_hoe");
    public static ItemPickaxeBase steel_pickaxe = new ItemPickaxeBase(Metallurgy_5.steelToolMaterial, "steel_pickaxe");
    public static ItemShovelBase steel_shovel = new ItemShovelBase(Metallurgy_5.steelToolMaterial, "steel_shovel");
    public static ItemSwordBase steel_sword = new ItemSwordBase(Metallurgy_5.steelToolMaterial, "steel_sword");

    public static ItemAxeBase tartarite_axe = new ItemAxeBase(Metallurgy_5.tartariteToolMaterial, "tartarite_axe");
    ...
    public static void registerModels()
    {
        ...
        amordrine_axe.registerItemModel(amordrine_axe, 0);
        amordrine_hoe.registerItemModel(amordrine_hoe, 0);
        amordrine_pickaxe.registerItemModel(amordrine_pickaxe, 0);
        amordrine_shovel.registerItemModel(amordrine_shovel, 0);
        amordrine_sword.registerItemModel(amordrine_sword, 0);

        angmallen_axe.registerItemModel(angmallen_axe, 0);
        angmallen_hoe.registerItemModel(angmallen_hoe, 0);
        angmallen_pickaxe.registerItemModel(angmallen_pickaxe, 0);
        angmallen_shovel.registerItemModel(angmallen_shovel, 0);
        angmallen_sword.registerItemModel(angmallen_sword, 0);
        ...
        atlarus_axe.registerItemModel(atlarus_axe, 0);
        atlarus_hoe.registerItemModel(atlarus_hoe, 0);
        atlarus_pickaxe.registerItemModel(atlarus_pickaxe, 0);
        atlarus_shovel.registerItemModel(atlarus_shovel, 0);
        atlarus_sword.registerItemModel(atlarus_sword, 0);

        black_steel_axe.registerItemModel(black_steel_axe, 0);
        black_steel_hoe.registerItemModel(black_steel_hoe, 0);
        black_steel_pickaxe.registerItemModel(black_steel_pickaxe, 0);
        black_steel_shovel.registerItemModel(black_steel_shovel, 0);
        black_steel_sword.registerItemModel(black_steel_sword, 0);

        brass_axe.registerItemModel(brass_axe, 0);
        brass_hoe.registerItemModel(brass_hoe, 0);
        brass_pickaxe.registerItemModel(brass_pickaxe, 0);
        brass_shovel.registerItemModel(brass_shovel, 0);
        brass_sword.registerItemModel(brass_sword, 0);

        bronze_axe.registerItemModel(bronze_axe, 0);
        bronze_hoe.registerItemModel(bronze_hoe, 0);
        bronze_pickaxe.registerItemModel(bronze_pickaxe, 0);
        bronze_shovel.registerItemModel(bronze_shovel, 0);
        bronze_sword.registerItemModel(bronze_sword, 0);
        ...
        celenegil_axe.registerItemModel(celenegil_axe, 0);
        celenegil_hoe.registerItemModel(celenegil_hoe, 0);
        celenegil_pickaxe.registerItemModel(celenegil_pickaxe, 0);
        ...
        damascus_steel_shovel.registerItemModel(damascus_steel_shovel, 0);
        damascus_steel_sword.registerItemModel(damascus_steel_sword, 0);

        deep_iron_axe.registerItemModel(deep_iron_axe, 0);
        deep_iron_hoe.registerItemModel(deep_iron_hoe, 0);
        deep_iron_pickaxe.registerItemModel(deep_iron_pickaxe, 0);
        deep_iron_shovel.registerItemModel(deep_iron_shovel, 0);
        deep_iron_sword.registerItemModel(deep_iron_sword, 0);

        desichalkos_axe.registerItemModel(desichalkos_axe, 0);
        desichalkos_hoe.registerItemModel(desichalkos_hoe, 0);
        desichalkos_pickaxe.registerItemModel(desichalkos_pickaxe, 0);
        desichalkos_shovel.registerItemModel(desichalkos_shovel, 0);
        desichalkos_sword.registerItemModel(desichalkos_sword, 0);

        electrum_axe.registerItemModel(electrum_axe, 0);
        electrum_hoe.registerItemModel(electrum_hoe, 0);
        electrum_pickaxe.registerItemModel(electrum_pickaxe, 0);
        electrum_shovel.registerItemModel(electrum_shovel, 0);
        electrum_sword.registerItemModel(electrum_sword, 0);
        ...
        haderoth_axe.registerItemModel(haderoth_axe, 0);
        haderoth_hoe.registerItemModel(haderoth_hoe, 0);
        haderoth_pickaxe.registerItemModel(haderoth_pickaxe, 0);
        haderoth_shovel.registerItemModel(haderoth_shovel, 0);
        haderoth_sword.registerItemModel(haderoth_sword, 0);

        hepatizon_axe.registerItemModel(hepatizon_axe, 0);
        hepatizon_hoe.registerItemModel(hepatizon_hoe, 0);
        hepatizon_pickaxe.registerItemModel(hepatizon_pickaxe, 0);
        hepatizon_shovel.registerItemModel(hepatizon_shovel, 0);
        hepatizon_sword.registerItemModel(hepatizon_sword, 0);
        ...
        ignatius_shovel.registerItemModel(ignatius_shovel, 0);
        ignatius_sword.registerItemModel(ignatius_sword, 0);

        inolashite_axe.registerItemModel(inolashite_axe, 0);
        inolashite_hoe.registerItemModel(inolashite_hoe, 0);
        inolashite_pickaxe.registerItemModel(inolashite_pickaxe, 0);
        inolashite_shovel.registerItemModel(inolashite_shovel, 0);
        inolashite_sword.registerItemModel(inolashite_sword, 0);

        kalendrite_axe.registerItemModel(kalendrite_axe, 0);
        kalendrite_hoe.registerItemModel(kalendrite_hoe, 0);
        ...
        orichalcum_axe.registerItemModel(orichalcum_axe, 0);
        orichalcum_hoe.registerItemModel(orichalcum_hoe, 0);
        orichalcum_pickaxe.registerItemModel(orichalcum_pickaxe, 0);
        orichalcum_shovel.registerItemModel(orichalcum_shovel, 0);
        orichalcum_sword.registerItemModel(orichalcum_sword, 0);

        oureclase_axe.registerItemModel(oureclase_axe, 0);
        oureclase_hoe.registerItemModel(oureclase_hoe, 0);
        oureclase_pickaxe.registerItemModel(oureclase_pickaxe, 0);
        oureclase_shovel.registerItemModel(oureclase_shovel, 0);
        oureclase_sword.registerItemModel(oureclase_sword, 0);

        platinum_axe.registerItemModel(platinum_axe, 0);
        platinum_hoe.registerItemModel(platinum_hoe, 0);
        platinum_pickaxe.registerItemModel(platinum_pickaxe, 0);
        platinum_shovel.registerItemModel(platinum_shovel, 0);
        platinum_sword.registerItemModel(platinum_sword, 0);
        ...
        shadow_steel_axe.registerItemModel(shadow_steel_axe, 0);
        shadow_steel_hoe.registerItemModel(shadow_steel_hoe, 0);
        shadow_steel_pickaxe.registerItemModel(shadow_steel_pickaxe, 0);
        shadow_steel_shovel.registerItemModel(shadow_steel_shovel, 0);
        shadow_steel_sword.registerItemModel(shadow_steel_sword, 0);
        ...
        steel_axe.registerItemModel(steel_axe, 0);
        steel_hoe.registerItemModel(steel_hoe, 0);
        steel_pickaxe.registerItemModel(steel_pickaxe, 0);
        steel_shovel.registerItemModel(steel_shovel, 0);
        steel_sword.registerItemModel(steel_sword, 0);

        tartarite_axe.registerItemModel(tartarite_axe, 0);
        tartarite_hoe.registerItemModel(tartarite_hoe, 0);
        tartarite_pickaxe.registerItemModel(tartarite_pickaxe, 0);
        tartarite_shovel.registerItemModel(tartarite_shovel, 0);
        tartarite_sword.registerItemModel(tartarite_sword, 0);
