...
//	Armor
	...
	public static final ItemArmor.ArmorMaterial rubracaciumArmorMaterial = EnumHelper.addArmorMaterial("RUBRACIUM", MODID + ":rubracacium",31,new int[]{2, 4, 5, 3},10, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 2.0F);
