<<<<<<< HEAD:src/main/java/hurts/metallurgy_5/Metallurgy_5.java
...
//	Armor
	public static final ItemArmor.ArmorMaterial astralSilverArmorMaterial = EnumHelper.addArmorMaterial("ASTRAL_SILVER", MODID + ":astral_silver", 15, new int[]{2, 5, 6, 2}, 9, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 3.0F);
	public static final ItemArmor.ArmorMaterial adamantineMaterial = EnumHelper.addArmorMaterial("ADAMANTINE", MODID + ":adamantine", 19, new int[]{3, 4, 5, 3}, 10, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 3.5F);
	public static final ItemArmor.ArmorMaterial atlarusArmorMaterial = EnumHelper.addArmorMaterial("ATLARUS", MODID + ":atlarus", 19, new int[]{3, 3, 4, 2},11 ,SoundEvents.ITEM_ARMOR_EQUIP_IRON,3.5F);
	public static final ItemArmor.ArmorMaterial carmotMaterial = EnumHelper.addArmorMaterial("CARMOT", MODID + ":carmot", 17, new int[]{2, 4, 5, 2}, 7, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 1.2F);
	public static final ItemArmor.ArmorMaterial mithrilMaterial = EnumHelper.addArmorMaterial("MITHRIL", MODID + ":mithril", 20, new int[]{2, 4, 5, 3}, 8, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 2.0F);
	public static final ItemArmor.ArmorMaterial prometheumMaterial = EnumHelper.addArmorMaterial("PROMETHEUM", MODID + ":prometherum", 30, new int[]{1, 2, 3, 2}, 7 ,SoundEvents.ITEM_ARMOR_EQUIP_IRON, 1.5F);
	public static final ItemArmor.ArmorMaterial rubracaciumArmorMaterial = EnumHelper.addArmorMaterial("RUBRACIACIUM", MODID + ":rubracacium", 25, new int[]{2, 4, 5, 2}, 0, SoundEvents.ENTITY_CREEPER_DEATH, 2.5F);
...
>>>>>>> dav-1.12.2:src/main/java/it/hurts/metallurgy_5/Metallurgy_5.java
