...
public class MetalStats {
     ...
     */
    public MetalStats(String name, String oreDictName, int blockHarvest, ArmorStats armor, ToolStats tool, FluidStats fluid, int oreHarvest) {
        this.name = name;
    ...
    public static class FluidStats {
        ...
        private final static ResourceLocation default_still = new ResourceLocation(Metallurgy_5.MODID, "blocks/molten_metal_still");
        private final static ResourceLocation default_flowing = new ResourceLocation(Metallurgy_5.MODID, "blocks/molten_metal_flow");
