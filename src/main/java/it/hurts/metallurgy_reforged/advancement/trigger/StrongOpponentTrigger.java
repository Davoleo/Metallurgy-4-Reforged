...
public class StrongOpponentTrigger extends MetallurgyTrigger<CommonCriterionInstances.AlwaysTrue> {

	private static final ResourceLocation ID = new ResourceLocation(Metallurgy.MODID, "strong_opponent");

	public StrongOpponentTrigger()
	{
		super(ID);
	}
