...
public class LowTemperaturesTrigger extends MetallurgyTrigger<CommonCriterionInstances.AlwaysTrue> {

	private static final ResourceLocation ID = new ResourceLocation(Metallurgy.MODID, "low_temperatures");

	public LowTemperaturesTrigger()
	{
		super(ID);
	}
