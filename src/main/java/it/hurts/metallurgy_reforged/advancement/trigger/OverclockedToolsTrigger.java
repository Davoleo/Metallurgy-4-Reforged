...
public class OverclockedToolsTrigger extends MetallurgyTrigger<CommonCriterionInstances.AlwaysTrue> {

	public static final ResourceLocation ID = new ResourceLocation(Metallurgy.MODID, "overclocked_tools");

	public OverclockedToolsTrigger()
	{
		super(ID);
	}
