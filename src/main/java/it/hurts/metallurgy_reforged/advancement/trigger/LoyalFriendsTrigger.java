...
public class LoyalFriendsTrigger extends MetallurgyTrigger<CommonCriterionInstances.AlwaysTrue> {

	private static final ResourceLocation ID = new ResourceLocation(Metallurgy.MODID, "loyal_friends");

	public LoyalFriendsTrigger()
	{
		super(ID);
	}
