...
public class ModArmors {
    ...
    public static ItemArmorBase adamantine_helmet = new ItemArmorBase(ModMetals.ADAMANTINE.getArmorMaterial(), EntityEquipmentSlot.HEAD, "adamantine_helmet");
    public static ItemArmorBase adamantine_chest = new ItemArmorBase(ModMetals.ADAMANTINE.getArmorMaterial(), EntityEquipmentSlot.CHEST, "adamantine_chest");
    public static ItemArmorBase adamantine_legs = new ItemArmorBase(ModMetals.ADAMANTINE.getArmorMaterial(), EntityEquipmentSlot.LEGS, "adamantine_legs");
    public static ItemArmorBase adamantine_boots = new ItemArmorBase(ModMetals.ADAMANTINE.getArmorMaterial(), EntityEquipmentSlot.FEET, "adamantine_boots");

    public static ItemArmorBase amordrine_helmet = new ItemArmorBase(ModMetals.AMORDRINE.getArmorMaterial(), EntityEquipmentSlot.HEAD, "amordrine_helmet");
    public static ItemArmorBase amordrine_chest = new ItemArmorBase(ModMetals.AMORDRINE.getArmorMaterial(), EntityEquipmentSlot.CHEST, "amordrine_chest");
    public static ItemArmorBase amordrine_legs = new ItemArmorBase(ModMetals.AMORDRINE.getArmorMaterial(), EntityEquipmentSlot.LEGS, "amordrine_legs");
    public static ItemArmorBase amordrine_boots = new ItemArmorBase(ModMetals.AMORDRINE.getArmorMaterial(), EntityEquipmentSlot.FEET, "amordrine_boots");

    public static ItemArmorBase angmallen_helmet = new ItemArmorBase(ModMetals.ANGMALLEN.getArmorMaterial(), EntityEquipmentSlot.HEAD, "angmallen_helmet");
    public static ItemArmorBase angmallen_chest = new ItemArmorBase(ModMetals.ANGMALLEN.getArmorMaterial(), EntityEquipmentSlot.CHEST, "angmallen_chest");
    public static ItemArmorBase angmallen_legs = new ItemArmorBase(ModMetals.ANGMALLEN.getArmorMaterial(), EntityEquipmentSlot.LEGS, "angmallen_legs");
    public static ItemArmorBase angmallen_boots = new ItemArmorBase(ModMetals.ANGMALLEN.getArmorMaterial(), EntityEquipmentSlot.FEET, "angmallen_boots");

    public static ItemArmorBase astral_silver_helmet = new ItemArmorBase(ModMetals.ASTRAL_SILVER.getArmorMaterial(), EntityEquipmentSlot.HEAD, "astral_silver_helmet");
    public static ItemArmorBase astral_silver_chest = new ItemArmorBase(ModMetals.ASTRAL_SILVER.getArmorMaterial(), EntityEquipmentSlot.CHEST, "astral_silver_chest");
    public static ItemArmorBase astral_silver_legs = new ItemArmorBase(ModMetals.ASTRAL_SILVER.getArmorMaterial(), EntityEquipmentSlot.LEGS, "astral_silver_legs");
    public static ItemArmorBase astral_silver_boots = new ItemArmorBase(ModMetals.ASTRAL_SILVER.getArmorMaterial(), EntityEquipmentSlot.FEET, "astral_silver_boots");
    ...
    public static ItemArmorBase carmot_helmet = new ItemArmorBase(ModMetals.CARMOT.getArmorMaterial(), EntityEquipmentSlot.HEAD, "carmot_helmet");
    public static ItemArmorBase carmot_chest = new ItemArmorBase(ModMetals.CARMOT.getArmorMaterial(), EntityEquipmentSlot.CHEST, "carmot_chest");
    public static ItemArmorBase carmot_legs = new ItemArmorBase(ModMetals.CARMOT.getArmorMaterial(), EntityEquipmentSlot.LEGS, "carmot_legs");
    public static ItemArmorBase carmot_boots = new ItemArmorBase(ModMetals.CARMOT.getArmorMaterial(), EntityEquipmentSlot.FEET, "carmot_boots");

    public static ItemArmorBase celenegil_helmet = new ItemArmorBase(ModMetals.CELENEGIL.getArmorMaterial(), EntityEquipmentSlot.HEAD, "celenegil_helmet");
    public static ItemArmorBase celenegil_chest = new ItemArmorBase(ModMetals.CELENEGIL.getArmorMaterial(), EntityEquipmentSlot.CHEST, "celenegil_chest");
    public static ItemArmorBase celenegil_legs = new ItemArmorBase(ModMetals.CELENEGIL.getArmorMaterial(), EntityEquipmentSlot.LEGS, "celenegil_legs");
    public static ItemArmorBase celenegil_boots = new ItemArmorBase(ModMetals.CELENEGIL.getArmorMaterial(), EntityEquipmentSlot.FEET, "celenegil_boots");
    ...
    public static ItemArmorBase deep_iron_helmet = new ItemArmorBase(ModMetals.DEEP_IRON.getArmorMaterial(), EntityEquipmentSlot.HEAD, "deep_iron_helmet");
    public static ItemArmorBase deep_iron_chest = new ItemArmorBase(ModMetals.DEEP_IRON.getArmorMaterial(), EntityEquipmentSlot.CHEST, "deep_iron_chest");
    public static ItemArmorBase deep_iron_legs = new ItemArmorBase(ModMetals.DEEP_IRON.getArmorMaterial(), EntityEquipmentSlot.LEGS, "deep_iron_legs");
    public static ItemArmorBase deep_iron_boots = new ItemArmorBase(ModMetals.DEEP_IRON.getArmorMaterial(), EntityEquipmentSlot.FEET, "deep_iron_boots");
    ...
    public static ItemArmorBase kalendrite_helmet = new ItemArmorBase(ModMetals.KALENDRITE.getArmorMaterial(), EntityEquipmentSlot.HEAD, "kalendrite_helmet");
    public static ItemArmorBase kalendrite_chest = new ItemArmorBase(ModMetals.KALENDRITE.getArmorMaterial(), EntityEquipmentSlot.CHEST, "kalendrite_chest");
    public static ItemArmorBase kalendrite_legs = new ItemArmorBase(ModMetals.KALENDRITE.getArmorMaterial(), EntityEquipmentSlot.LEGS, "kalendrite_legs");
    public static ItemArmorBase kalendrite_boots = new ItemArmorBase(ModMetals.KALENDRITE.getArmorMaterial(), EntityEquipmentSlot.FEET, "kalendrite_boots");
    ...
    public static ItemArmorBase mithril_helmet = new ItemArmorBase(ModMetals.MITHRIL.getArmorMaterial(), EntityEquipmentSlot.HEAD, "mithril_helmet");
    public static ItemArmorBase mithril_chest = new ItemArmorBase(ModMetals.MITHRIL.getArmorMaterial(), EntityEquipmentSlot.CHEST, "mithril_chest");
    public static ItemArmorBase mithril_legs = new ItemArmorBase(ModMetals.MITHRIL.getArmorMaterial(), EntityEquipmentSlot.LEGS, "mithril_legs");
    public static ItemArmorBase mithril_boots = new ItemArmorBase(ModMetals.MITHRIL.getArmorMaterial(), EntityEquipmentSlot.FEET, "mithril_boots");
    ...
    public static ItemArmorBase platinum_helmet = new ItemArmorBase(ModMetals.PLATINUM.getArmorMaterial(), EntityEquipmentSlot.HEAD, "platinum_helmet");
    ...
    public static ItemArmorBase prometheum_helmet = new ItemArmorBase(ModMetals.PROMETHEUM.getArmorMaterial(), EntityEquipmentSlot.HEAD, "prometheum_helmet");
    public static ItemArmorBase prometheum_chest = new ItemArmorBase(ModMetals.PROMETHEUM.getArmorMaterial(), EntityEquipmentSlot.CHEST, "prometheum_chest");
    public static ItemArmorBase prometheum_legs = new ItemArmorBase(ModMetals.PROMETHEUM.getArmorMaterial(), EntityEquipmentSlot.LEGS, "prometheum_legs");
    public static ItemArmorBase prometheum_boots = new ItemArmorBase(ModMetals.PROMETHEUM.getArmorMaterial(), EntityEquipmentSlot.FEET, "prometheum_boots");
    ...
    public static ItemArmorBase vulcanite_helmet = new ItemArmorBase(ModMetals.VULCANITE.getArmorMaterial(), EntityEquipmentSlot.HEAD, "vulcanite_helmet");
    public static ItemArmorBase vulcanite_chest = new ItemArmorBase(ModMetals.VULCANITE.getArmorMaterial(), EntityEquipmentSlot.CHEST, "vulcanite_chest");
    public static ItemArmorBase vulcanite_legs = new ItemArmorBase(ModMetals.VULCANITE.getArmorMaterial(), EntityEquipmentSlot.LEGS, "vulcanite_legs");
    public static ItemArmorBase vulcanite_boots = new ItemArmorBase(ModMetals.VULCANITE.getArmorMaterial(), EntityEquipmentSlot.FEET, "vulcanite_boots");
