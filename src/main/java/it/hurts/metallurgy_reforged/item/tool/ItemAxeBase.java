...
public class ItemAxeBase extends AxeItem implements IHasModel {

    private EnumToolEffects effect;
    private Enchantment enchantment;
	private int enchantmentLevel;

    public ItemAxeBase(IItemTier material, String name)
    {
        this(material, name, null, -1);
    }
    
    public ItemAxeBase(IItemTier material, String name, Enchantment enchantment, int enchantmentLevel){
        super(material, GeneralConfig.powerAxes == false ? material.getAttackDamage() + 2 : material.getAttackDamage() + 4, -2.5F -(material.getAttackDamage()/10),  new Item.Properties().group(MetallurgyTabs.tabTool));
