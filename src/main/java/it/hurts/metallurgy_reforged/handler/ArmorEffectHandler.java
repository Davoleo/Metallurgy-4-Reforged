...
public class ArmorEffectHandler {
	...
	public static void onArmorTick(PlayerTickEvent event)
	{
		...
		if (EventUtils.isPlayerWearingSpecificArmorPiece(event.player, EntityEquipmentSlot.HEAD, ModMetals.PLATINUM.getArmorPiece(EntityEquipmentSlot.HEAD)) && ArmorEffectsConfig.platinumArmorEffect)
		{
