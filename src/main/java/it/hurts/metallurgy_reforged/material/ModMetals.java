...
public class ModMetals {
	...
	public static final Metal ANGMALLEN = new MetalStats("angmallen", "Angmallen", 2, Constants.MID_TIER_BLAST_RESISTANCE,
	...
	public static final Metal ALDUORITE = new MetalStats("alduorite", "Alduorite", 2, Constants.MID_TIER_BLAST_RESISTANCE, null, null, new FluidStats((int) MetalColors.ALDUORITE.getColorIntWithAlpha()), 3).createMetal();
	public static final Metal ASTRAL_SILVER = new MetalStats("astral_silver", "AstralSilver", 2, Constants.MID_TIER_BLAST_RESISTANCE,
	...
	public static final Metal ATLARUS = new MetalStats("atlarus", "Atlarus", 2, Constants.HIGH_TIER_BLAST_RESISTANCE,
	...
	public static final Metal BLACK_STEEL = new MetalStats("black_steel", "BlackSteel", 2, Constants.HIGH_TIER_BLAST_RESISTANCE,
	...
	public static final Metal BRASS = new MetalStats("brass", "Brass", 2, Constants.MID_TIER_BLAST_RESISTANCE,
	...
	public static final Metal BRONZE = new MetalStats("bronze", "Bronze", 2, Constants.HIGH_TIER_BLAST_RESISTANCE,
	...
	public static final Metal CARMOT = new MetalStats("carmot", "Carmot", 2, Constants.HIGH_TIER_BLAST_RESISTANCE,
	...
	public static final Metal CELENEGIL = new MetalStats("celenegil", "Celenegil", 2, Constants.EXTREME_TIER_BLAST_RESISTANCE,
	...
	public static final Metal CERUCLASE = new MetalStats("ceruclase", "Ceruclase", 2, Constants.HIGH_TIER_BLAST_RESISTANCE,
	...
	public static final Metal COPPER = new MetalStats("copper", "Copper", 2, Constants.LOW_TIER_BLAST_RESISTANCE,
	...
	public static final Metal DAMASCUS_STEEL = new MetalStats("damascus_steel", "DamascusSteel", 2, Constants.EXTREME_TIER_BLAST_RESISTANCE,
	...
	public static final Metal DEEP_IRON = new MetalStats("deep_iron", "DeepIron", 2, Constants.MID_TIER_BLAST_RESISTANCE,
	...
	public static final Metal DESICHALKOS = new MetalStats("desichalkos", "Desichalkos", 2, Constants.HIGH_TIER_BLAST_RESISTANCE,
	...
	public static final Metal ELECTRUM = new MetalStats("electrum", "Electrum", 2, Constants.LOW_TIER_BLAST_RESISTANCE,
	...
	public static final Metal HADEROTH = new MetalStats("haderoth", "Haderoth", 2, Constants.EXTREME_TIER_BLAST_RESISTANCE,
	...
	public static final Metal HEPATIZON = new MetalStats("hepatizon", "Hepatizon", 2, Constants.HIGH_TIER_BLAST_RESISTANCE,
	...
	public static final Metal IGNATIUS = new MetalStats("ignatius", "Ignatius", 2, Constants.LOW_TIER_BLAST_RESISTANCE,
	...
	public static final Metal INFUSCOLIUM = new MetalStats("infuscolium", "Infuscolium", 2, Constants.MID_TIER_BLAST_RESISTANCE, null, null, new FluidStats((int) MetalColors.INFUSCOLIUM.getColorIntWithAlpha()), 2).createMetal();
	public static final Metal INOLASHITE = new MetalStats("inolashite", "Inolashite", 2, Constants.EXTREME_TIER_BLAST_RESISTANCE,
	...
	public static final Metal KALENDRITE = new MetalStats("kalendrite", "Kalendrite", 2, Constants.HIGH_TIER_BLAST_RESISTANCE,
	...
	public static final Metal KRIK = new MetalStats("krik", "Krik", 2, Constants.MID_TIER_BLAST_RESISTANCE,
	...
	public static final Metal LEMURITE = new MetalStats("lemurite", "Lemurite", 2, Constants.LOW_TIER_BLAST_RESISTANCE, null, null, new FluidStats((int) MetalColors.LEMURITE.getColorIntWithAlpha()), 2).createMetal();
	public static final Metal LUTETIUM = new MetalStats("lutetium", "Lutetium", 2, Constants.HIGH_TIER_BLAST_RESISTANCE,
	...
	public static final Metal MANGANESE = new MetalStats("manganese", "Manganese", 2, Constants.MID_TIER_BLAST_RESISTANCE, null, null, new FluidStats((int) MetalColors.MANGANESE.getColorIntWithAlpha()), 3).createMetal();
	public static final Metal MEUTOITE = new MetalStats("meutoite", "Meutoite", 2, Constants.HIGH_TIER_BLAST_RESISTANCE, null, null, new FluidStats((int) MetalColors.MEUTOITE.getColorIntWithAlpha()), 4).createMetal();
	public static final Metal MIDASIUM = new MetalStats("midasium", "Midasium", 2, Constants.MID_TIER_BLAST_RESISTANCE,
	...
	public static final Metal MITHRIL = new MetalStats("mithril", "Mithril", 2, Constants.HIGH_TIER_BLAST_RESISTANCE,
	...
	public static final Metal ORICHALCUM = new MetalStats("orichalcum", "Orichalcum", 2, Constants.EXTREME_TIER_BLAST_RESISTANCE,
	...
	public static final Metal OSMIUM = new MetalStats("osmium", "Osmium", 2, Constants.EXTREME_TIER_BLAST_RESISTANCE,
	...
	public static final Metal OURECLASE = new MetalStats("oureclase", "Oureclase", 2, Constants.HIGH_TIER_BLAST_RESISTANCE,
	...
	public static final Metal PLATINUM = new MetalStats("platinum", "Platinum", 2, Constants.HIGH_TIER_BLAST_RESISTANCE,
	...
	public static final Metal PROMETHEUM = new MetalStats("prometheum", "Prometheum", 2, Constants.MID_TIER_BLAST_RESISTANCE,
	...
	public static final Metal QUICKSILVER = new MetalStats("quicksilver", "QuickSilver", 2, Constants.HIGH_TIER_BLAST_RESISTANCE,
	...
	public static final Metal RUBRACIUM = new MetalStats("rubracium", "Rubracium", 2, Constants.MID_TIER_BLAST_RESISTANCE, null, null, new FluidStats((int) MetalColors.RUBRACIUM.getColorIntWithAlpha()), 4).createMetal();
	public static final Metal SANGUINITE = new MetalStats("sanguinite", "Sanguinite", 2, Constants.EXTREME_TIER_BLAST_RESISTANCE,
	...
	public static final Metal SHADOW_IRON = new MetalStats("shadow_iron", "ShadowIron", 2, Constants.LOW_TIER_BLAST_RESISTANCE,
	...
	public static final Metal SHADOW_STEEL = new MetalStats("shadow_steel", "ShadowSteel", 2, Constants.MID_TIER_BLAST_RESISTANCE,
	...
	public static final Metal SILVER = new MetalStats("silver", "Silver", 2, Constants.MID_TIER_BLAST_RESISTANCE,
	...
	public static final Metal STEEL = new MetalStats("steel", "Steel", 2, Constants.HIGH_TIER_BLAST_RESISTANCE,
	...
	public static final Metal TARTARITE = new MetalStats("tartarite", "Tartarite", 2, Constants.EXTREME_TIER_BLAST_RESISTANCE,
	...
	public static final Metal TIN = new MetalStats("tin", "Tin", 2, Constants.LOW_TIER_BLAST_RESISTANCE, null, null, new FluidStats((int) MetalColors.TIN.getColorIntWithAlpha()), 1).createMetal();
	public static final Metal VULCANITE = new MetalStats("vulcanite", "Vulcanite", 2, Constants.HIGH_TIER_BLAST_RESISTANCE,
	...
	public static final Metal VYROXERES = new MetalStats("vyroxeres", "Vyroxeres", 2, Constants.HIGH_TIER_BLAST_RESISTANCE,
