...
public class CelenegilArmorEffect extends BaseMetallurgyEffect implements IProgressiveEffect {
	...
	public void onPlayerHurt(LivingHurtEvent event)
	{
		...
		ExtraFilledDataBundle data = getEffectCapability(entity).celenegilArmorBundle;
		...
		if (hits > 4)
		{
			...
			entity.addPotionEffect(new PotionEffect(MobEffects.REGENERATION, 20 + 20 * level, 1));
	...
	{
		ExtraFilledDataBundle bundle = getEffectCapability(player).celenegilArmorBundle;
