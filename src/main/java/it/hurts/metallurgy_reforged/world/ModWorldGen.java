...
public class ModWorldGen implements IWorldGenerator {
	...
	private void generateNether(Random random, int chunkX, int chunkZ, World world)
	{
		...
		generateOre(ModMetals.LUTETIUM, world, random, chunkX, chunkZ, WorldGenerationConfig.lutetium.veinSize, RARE, WorldGenerationConfig.lutetium.minY, WorldGenerationConfig.lutetium.maxY, new NetherOreSpawn(convertStringToBiome(WorldGenerationConfig.lutetium.biomes)));
