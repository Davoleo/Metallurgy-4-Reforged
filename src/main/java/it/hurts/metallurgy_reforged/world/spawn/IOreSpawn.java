...
public interface IOreSpawn {
	 ...
	 *
	 * @param chunk the chunk where the ore will spawn
	 ...
	 */
	boolean canOreSpawn(Chunk chunk, BlockPos pos, IBlockState state, Random random);
	 ...
	 */
	default int getRarity(Chunk chunk, int originalRarity)
	{
