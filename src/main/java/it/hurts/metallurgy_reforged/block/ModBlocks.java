...
public class ModBlocks {
	...
	public static BlockOre oreSulfur = new BlockOre("sulfur_ore", 3F, 2, Constants.BlastResistance.MID_TIER, null)
			.setDrops(new Drop(new ItemStack(ModItems.SULFUR, 4), 1F));
	public static BlockOre orePhosphorite = new BlockOre("phosphorite_ore", 3F, 2, Constants.BlastResistance.MID_TIER, null)
			.setDrops(new Drop(ModItems.PHOSPHORUS, 3, 1F));
	public static BlockOre oreTar = new BlockOre("tar_ore", 3F, 2, Constants.BlastResistance.MID_TIER, null)
			.setDrops(new Drop(ModItems.TAR, 2, 1F), new Drop(ModItems.BITUMEN, 2, 0.5F));
	public static BlockOre orePotash = new BlockOre("potash_ore", 3F, 2, Constants.BlastResistance.MID_TIER, null)
