    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        for (int i1 = 0; i1 < 1; ++i1)
        {
            ...
            if (this.isMouseOverSlot(slot, mouseX, mouseY) && slot.isEnabled())
            {
                ...
                this.drawGradientRect(j1 - 3, k1, j1 + 19, k1 + 2, -2130706433, -2130706433);
                this.drawGradientRect(j1 - 2, k1 + 2, j1 + 1 + 17, k1 + 5, -2130706433, -2130706433);
                this.drawGradientRect(j1 - 1, k1 + 5, j1 + 1 + 16, k1 + 8, -2130706433, -2130706433);
                this.drawGradientRect(j1, k1 + 8, j1 + 1 + 15, k1  + 11, -2130706433, -2130706433);
                this.drawGradientRect(j1 + 1, k1 + 11 , j1 + 1 + 14, k1 + 14, -2130706433, -2130706433);
                this.drawGradientRect(j1 + 2  , k1 + 14 , j1 + 1 + 13, k1 + 17, -2130706433, -2130706433);
        ...
        for (int i1 = 2; i1 < this.inventorySlots.inventorySlots.size(); ++i1)
        {
            Slot slot = this.inventorySlots.inventorySlots.get(i1);
