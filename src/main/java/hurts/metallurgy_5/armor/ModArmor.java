...
public class ModArmor {
	...
	public static ItemArmorBase carmot_helmet = (ItemArmorBase) new ItemArmorBase(Metallurgy_5.carmotMaterial,EntityEquipmentSlot.HEAD,"carmot_helmet").setCreativeTab(Metallurgy_5.tabArmor);
	public static ItemArmorBase carmot_chest = (ItemArmorBase) new ItemArmorBase(Metallurgy_5.carmotMaterial,EntityEquipmentSlot.CHEST,"carmot_chest").setCreativeTab(Metallurgy_5.tabArmor);
